...
class MongoStoreActivityRepository:
    def __init__(self, db: Database):
        self._collection = db.store_activity_configs

    def _to_doc(self, activity: StoreActivityConfig) -> dict:
        return {
            "_id": activity.id,
    ...
    def _from_doc(self, doc: dict) -> StoreActivityConfig:
        return StoreActivityConfig(
            id=doc["_id"],
