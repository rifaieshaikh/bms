...
_ICON_CLASSES: dict[str, str] = {
    ...
    # Dashboard summary cards (vaybooks.bms.ui.components.shared.dashboard_card)
    "users": "ti-users",
    "user-plus": "ti-user-plus",
    "user-exclamation": "ti-user-exclamation",
    "mail": "ti-mail",
    "shopping-bag": "ti-shopping-bag",
    "settings": "ti-settings",
    "list-check": "ti-list-check",
    "truck": "ti-truck",
    "truck-delivery": "ti-truck-delivery",
    "cash": "ti-cash",
    "cash-banknote": "ti-cash-banknote",
    "wallet": "ti-wallet",
    "file-invoice": "ti-file-invoice",
    "file-text": "ti-file-text",
    "receipt": "ti-receipt",
    "box": "ti-box",
    "box-off": "ti-box-off",
    "package": "ti-package",
    "alert-triangle": "ti-alert-triangle",
    "chart-line": "ti-chart-line",
    "chef-hat": "ti-chef-hat",
    "clock-hour-4": "ti-clock-hour-4",
