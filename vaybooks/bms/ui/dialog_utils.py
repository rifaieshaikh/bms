...
DIALOG_FLAG_PREFIXES = (
    ...
    "agent_pay_dialog",
    "agent_pay_agent_id",
    "agent_pay_invoice_id",
    "agent_pay_amount",
    "agent_duplicate_existing_id",
    "customer_add_dialog",
    ...
    "crm_lead_status_dialog",
    "crm_lead_lost_dialog",
    "crm_lead_reopen_dialog",
    "crm_lead_convert_dialog",
    "crm_lead_bulk_dialog",
    "crm_enquiry_add_dialog",
    "crm_enquiry_edit_dialog",
    "crm_enquiry_assign_dialog",
    "crm_enquiry_status_dialog",
    "crm_activity_add_dialog",
    "crm_activity_complete_dialog",
    "crm_activity_reschedule_dialog",
    "crm_activity_cancel_dialog",
    "crm_whatsapp_reminder_dialog",
    ...
    "settings_location_add_dialog",
    "settings_location_edit_dialog",
    "stock_transfer_dialog",
